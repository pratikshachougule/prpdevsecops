...
//       	}
    ...
    stage ('Deploy to server') {
	   ...
	   timeout(time: 10, unit: 'MINUTES') {
		...
		sh 'ssh -o  StrictHostKeyChecking=no root@15.206.127.110  "nohup java -jar /WebGoat/webgoat-server-v8.2.0-SNAPSHOT.jar --server.address=15.206.127.110  --server.port=9999 &"'
                  }
	     }
        }     
    }

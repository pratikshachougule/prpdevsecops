pipeline {
  ...
  stages {
   ...
   stage ('DAST - OWASP ZAP') {
		...
		sh 'ssh -o  StrictHostKeyChecking=no apps@10.97.109.243 "sudo docker run --rm -v /home/apps:/zap/wrk/:rw -t owasp/zap2docker-stable zap-full-scan.py -t http://13.232.36.252:8080/WebGoat -x zap_report || true" '
